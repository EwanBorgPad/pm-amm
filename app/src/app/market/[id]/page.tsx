  ...
  return (
    <>
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-[48px] py-[32px]">
        ...
        {!isLoading && !market && (
          <p className="text-no font-mono text-[12px]">Market #{id} not found.</p>
        )}
            ...
            return (
              <div className="space-y-[24px]">
                ...
                {isResolved ? (
                  ...
                  <div className="space-y-[24px]">
                    <div
                      className={`border p-[24px] text-center space-y-[8px] ${
                        market.winningSide === 1 ? "border-yes/30 bg-yes/5" : "border-no/30 bg-no/5"
                      }`}
                    >
                      <p className="text-[11px] font-mono text-muted uppercase tracking-[0.08em]">
                        Resolved
                      </p>
                      <p
                        className={`text-[32px] font-mono font-bold tracking-tight ${
